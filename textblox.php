<?php
/*
Plugin Name: Powie's TextBlox - text blocks
Description: Organize textblocks, sections, areas and insert it in your posts or pages using shortcodes
Author: PowieT
Author URI: https://www.powie.de
Plugin URI: https://www.powie.de/wordpress/textblox-plugin/
Version: 0.9.6
Text Domain: textblox
...
function add_tb_option_page() {
	...
	add_options_page(__('TextBlox Setup', 'textblox'),__('TextBlox Setup', 'textblox'), 'manage_options', TB_PLUGIN_DIR.'/textblox_settings.php');
}
...
if ( !isset($_REQUEST['post_type']) or ( isset($_REQUEST['post_type']) and $_REQUEST['post_type'] != 'textblox') ) {
